...
// silently truncated, never accepted and then failing later. See this
// stage's own final report for the exact "large video = not yet ready"
// verdict and recommended follow-up (direct-to-S3 presigned multipart/
// resumable upload + background finalization).
